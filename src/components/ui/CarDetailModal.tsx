    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative w-full max-w-4xl bg-[#0a0a0a] border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl z-10 my-8 overflow-hidden"
        >
          {/* Close button */}
          <button
            onClick={onClose}
            className="absolute top-6 right-6 p-2.5 rounded-full bg-white/10 hover:bg-white/20 text-white z-20 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
            ...
            <div className="space-y-6 flex flex-col justify-between">
              ...
              <div className="pt-4 border-t border-white/10 flex items-center gap-4">
                <button
                  ...
                  className="flex-1 py-3.5 rounded-xl bg-[#FF2D20] hover:bg-[#e02619] text-black font-heading text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 shadow-lg shadow-[#FF2D20]/20 transition-all"
                >
